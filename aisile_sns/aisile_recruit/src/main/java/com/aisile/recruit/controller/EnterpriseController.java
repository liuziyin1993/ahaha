...
import com.aisile.recruit.pojo.Enterprise;
import com.aisile.recruit.service.EnterpriseService;
...
public class EnterpriseController {
	...
	public Result findByIshot( ){
		List<Enterprise> byIshot = enterpriseService.findByIsHot(MyConstants.IS_HOT);
		return new Result(true,StatusCode.OK,"查询热门企业成功", byIshot);
	}
